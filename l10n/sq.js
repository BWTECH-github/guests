OC.L10N.register(
    ...
    "Error" : "Gabim",
    "Add multiple users and guests" : "Shtoni disa përdorues dhe mysafirë",
    ...
    "No such guest user" : "S’ka përdorues mysafir të tillë",
    "The token is invalid" : "Token-i është i pavlefshëm",
    ...
    "Add guest: {email}" : "Shto mysafir: {email}",
    "Error while sharing. The guest user has been removed. Please check if sharing is allowed for this user." : "Gabim gjatë ndarjes. Përdoruesi mysafir u hoq. Ju lutemi kontrolloni nëse ndarja lejohet për këtë përdorues.",
    "User is not a guest user." : "Përdoruesi nuk është mysafir.",
    "Cannot remove an active guest user." : "Nuk mund të hiqet një mysafir aktiv.",
    "Guest user was created too long ago to be removed automatically." : "Përdoruesi mysafir u krijua shumë kohë më parë për t'u hequr automatikisht.",
    "User not found." : "Përdoruesi nuk u gjet.",
    "Guest user removed." : "Përdoruesi mysafir u hoq."
},
