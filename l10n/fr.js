OC.L10N.register(
    ...
    "Saved" : "Enregistré",
    "Domain is blocked." : "Le domaine est bloqué.",
    ...
    "Add guest: {email}" : "Ajouter un invité : {email}",
    "Error while sharing. The guest user has been removed. Please check if sharing is allowed for this user." : "Erreur lors du partage. L'utilisateur invité a été supprimé. Veuillez vérifier si le partage est autorisé pour cet utilisateur.",
    "User is not a guest user." : "L'utilisateur n'est pas un utilisateur invité.",
    "Cannot remove an active guest user." : "Impossible de supprimer un utilisateur invité actif.",
    "Guest user was created too long ago to be removed automatically." : "L'utilisateur invité a été créé il y a trop longtemps pour être supprimé automatiquement.",
    "User not found." : "Utilisateur introuvable.",
    "Guest user removed." : "Utilisateur invité supprimé."
},
