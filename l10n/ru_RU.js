OC.L10N.register(
    ...
    "Hey there,\n\njust letting you know that %s shared %s with you.\n\nActivate your guest account at %s by setting a password: %s\n\nThen view it: %s\n\nYou can login using the email address \"%s\".\n\n" : "Привет всем,\n\nпросто хочу %s поделиться %s с тобой.\n\nАктивируйте ваш аккаунт %s для этого установите пароль: %s\n\nТеперь посмотрите на это: %s\n\nВы можете использовать в качестве Имени - почтовый адрес \"%s\".\n",
