OC.L10N.register(
    ...
    "Hey there,<br><br>\n         \n         just letting you know that %s shared files with you.<br><br>\n         Activate your guest account at %s by <a href=\"%s\">setting a password</a>.<br><br>\n         <br><br>You can login using the email address <strong>\"%s\"</strong> .<br><br>" : "안녕하세요,<br><br>\n         \n          %s 님이 당신에게 파일을 공유했습니다.<br><br>\n         <a href=\"%s\">암호를 설정</a>해서 %s 손님 계정을 활성화할 수 있습니다.<br><br>\n         <br><br>이메일 주소<strong>\"%s\"을(를) 사용하여 로그인할 수 있습니다</strong> .<br><br>",
