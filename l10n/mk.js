OC.L10N.register(
    ...
    "Hey there,\n\njust letting you know that %s shared %s with you.\n\nActivate your guest account at %s by setting a password: %s\n\nThen view it: %s\n\nYou can login using the email address \"%s\".\n\n" : "Здраво,\n\nВе известуваме дека %s ви испрати линк од %s.\n\nАктивирајте го вашиот налог на %s и поставете ваша лозинка: %s\n\nПотоа најавете се: %s\n\nВашата Email адреса е \"%s\".\n\n",
    "The share will expire on %s." : "Овој линк е достапен до %s.",
    "Cheers!" : "Поздрав!",
    "Hey there,<br><br>\n         \n         just letting you know that %s shared <strong>%s</strong> with you.<br><br>\n         Activate your guest account at %s by <a href=\"%s\">setting a password</a>.<br><br>\n         Then <a href=\"%s\">view it!</a><br><br>You can login using the email address <strong>\"%s\"</strong> .<br><br>" : "Здраво,<br><br>\n         \n         Ве известуваме дека %s ви испрати линк од <strong>%s</strong>.<br><br>\n         Активирајте го вашиот налог на %s и <a href=\"%s\">поставете лозинка</a>.<br><br>\n         Потоа <a href=\"%s\">најавете се!</a><br><br>Вашата Email адреса е <strong>\"%s\"</strong> .<br><br>",
