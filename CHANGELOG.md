...
- Die vier deutschen `.js`-Sprachdateien waren seit 1.0.0 syntaktisch kaputt:
  die neuen Texte standen hinter der Abschlusszeile
  (`"nplurals=…");`) statt im Übersetzungsobjekt. Eine Sprachdatei, die nicht
  parst, registriert ihr Bündel nicht — die Oberfläche der App fiel damit im
  Deutschen vollständig auf Englisch zurück. Die Texte selbst waren richtig und
  stehen jetzt an der richtigen Stelle.
